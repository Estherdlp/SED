...
void read_sw_antirrebote(int *pulsadorSAVE){
...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		/* USER CODE END WHILE */
		/* USER CODE BEGIN 3 */
		if (!(GPIOA -> IDR & GPIO_PIN_4)){				//Lectura botones de seleccion D1D0 al pulsar save
			read_sw_antirrebote(&pulsadorSAVE);			//Llamada funcion antirrebote
			if (pulsadorSAVE == 1){
				aux = 1;
